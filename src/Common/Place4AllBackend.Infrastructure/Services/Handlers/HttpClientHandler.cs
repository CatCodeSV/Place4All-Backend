...
namespace Place4AllBackend.Infrastructure.Services.Handlers
{
    public class HttpClientHandler : IHttpClientHandler
    {
            ...
            where TResult : class where TRequest : class
        {
            ...
            {
                _logger.LogError(ex, "HttpClient Request: Unhandled Exception for Request {RequestName} {@Request}",
                    requestName, requestEntity);
