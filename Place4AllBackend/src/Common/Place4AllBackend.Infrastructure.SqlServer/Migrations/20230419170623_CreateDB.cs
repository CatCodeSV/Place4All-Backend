        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisabilityDegree = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AdditionalFeaturesId = table.Column<int>(type: "int", nullable: false),
                    ReviewsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReviewFeature", x => new { x.AdditionalFeaturesId, x.ReviewsId });
                    table.ForeignKey(
                        name: "FK_ReviewFeature_Features_AdditionalFeaturesId",
                        column: x => x.AdditionalFeaturesId,
                        principalTable: "Features",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReviewFeature_Reviews_ReviewsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReviewFeature_ReviewsId",
                table: "ReviewFeature",
                column: "ReviewsId");
